...
## Content
Using: Lists, append(), pop(), insert(), sort(). 

| Project  | Description |
| ------------- | ------------- |
| Basketball Roster  | This program will build and display basketball roster based off user input.  |
| Favorite Teachers  | This program will create a list of a user's favorite teachers and display these teachers ranked.  |
| Grade Sorter  | This program will collect four grades from the user and will sort it from highest to lowest.  |
| Grocery List App  | This program will simulate a grocery shipping list.  |
| Types of List Sort  | This program will highlight the similarities and differences between four different types of lists: list of strings, of integers, of floats, and list of list  |
